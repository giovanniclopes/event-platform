export default function TermsOfUse() {
  return (
    <div className="p-12 py-24">
      <h2>
        <span className="text-[rgb(68, 68, 68)]">1. Termos</span>
      </h2>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          Ao acessar ao site <a href="https://intellion.com">IntelliOn</a>,
      ...
      <h2>
        <span className="text-[rgb(68, 68, 68)]">2. Uso de Licença</span>
      </h2>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          É concedida permissão para baixar temporariamente uma cópia dos
          materiais (informações ou software) no site IntelliOn , apenas para
      ...
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          ...
          dessas restrições e poderá ser rescindida por IntelliOn a qualquer
      ...
      <ol>
        <li>
          <span className="text-[rgb(68, 68, 68)]">
            Os materiais no site da IntelliOn são fornecidos 'como estão'.
            IntelliOn não oferece garantias, expressas ou implícitas, e, por
        ...
        <li>
          <span className="text-[rgb(68, 68, 68)]">
            Além disso, o IntelliOn não garante ou faz qualquer representação
      ...
      <h2>
        <span className="text-[rgb(68, 68, 68)]">4. Limitações</span>
      </h2>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          Em nenhum caso o IntelliOn ou seus fornecedores serão responsáveis
          ...
          uso ou da incapacidade de usar os materiais em IntelliOn, mesmo que
          IntelliOn ou um representante autorizado da IntelliOn tenha sido
      ...
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          Os materiais exibidos no site da IntelliOn podem incluir erros
          técnicos, tipográficos ou fotográficos. IntelliOn não garante que
          qualquer material em seu site seja preciso, completo ou atual.
          IntelliOn pode fazer alterações nos materiais contidos em seu site a
          qualquer momento, sem aviso prévio. No entanto, IntelliOn não se
          compromete a atualizar os materiais.
        </span>
      </p>
      <h2>
        <span className="text-[rgb(68, 68, 68)]">6. Links</span>
      </h2>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          O IntelliOn não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por IntelliOn do site. O uso de
      ...
      <h3>
        <span className="text-[rgb(68, 68, 68)]">Modificações</span>
      </h3>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          O IntelliOn pode revisar estes termos de serviço do site a qualquer
          momento, sem aviso prévio. Ao usar este site, você concorda em ficar
          vinculado à versão atual desses termos de serviço.
        </span>
      </p>
      <h3>
        <span className="text-[rgb(68, 68, 68)]">Lei aplicável</span>
      </h3>
      <p>
        <span className="text-[rgb(68, 68, 68)]">
          Estes termos e condições são regidos e interpretados de acordo com as
          leis do IntelliOn e você se submete irrevogavelmente à jurisdição
