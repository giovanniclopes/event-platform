      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16 mbl:block">
          ...
          <div className="flex flex-col gap-4 mbl:mt-10">
            ...
            <a
              href=""
              className="p-4 text-sm border border-product-lightPink text-product-lightPink flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-product-lightPink hover:text-gray-900 transition-colors"
            >
              <Lightning size={24} />
              Acesse o desafio
            </a>
        ...
        <div className="gap-8 mt-20 grid grid-cols-2 mbl:grid-cols-1">
          <a
            href={data.lesson.complementaryMaterial[0]?.url}
            target="_blank"
            download
